...
from monitors import OutsideTheBoxMonitor, GaussianMixtureMonitor
...
all_layers_ids = [#list(range(0, 29, 4)) + [30, 31, 32],
                  # list(range(0, 99, 12)) + [97, 98]
                  [98]]
...
save_results_path = "Results/Layers_Approach/"
if not os.path.exists(save_results_path):
    os.makedirs(save_results_path)
f = open(save_results_path + "Expe_281022.csv", "w", encoding="UTF8")
writer = csv.writer(f)
